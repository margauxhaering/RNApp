...
- <b> Elbow Method </b></br>
The elbow method consists on  choosing the number of clusters corresponding to the point where the line forms a elbow. </br>
...
The plots are showing automatically and a R environment "clusters_list.rda" is saved on your computer's desktop. </br>
You can open the environment on R, and the list will be accessible by  "clusters_list". 
<br/>
<br/>
